...
class ModelManager:
    ...
    def _request(self, path: str, method: str = "GET", timeout: int = 10) -> dict[str, Any] | None:
    ...
    def _post(self, path: str, data: dict | None = None, timeout: int = 30) -> dict[str, Any] | None:
        url = f"{self.base_url}/{path.lstrip('/')}"
        headers = {"Content-Type": "application/json"}
    ...
    def is_model_loaded(self, model_id: str) -> bool:
        ...
        return any(model_id in lid for lid in loaded)

    def load_model(self, model_id: str) -> bool:
        """Load a model into LM Studio."""
        response = self._post("models/load", {"model": model_id}, timeout=120)
        return response is not None

    def unload_model(self, model_id: str) -> bool:
        """Unload a model from LM Studio."""
        response = self._post("models/unload", {"model": model_id}, timeout=30)
        return response is not None
